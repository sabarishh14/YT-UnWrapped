...
export default function MonthCapsule({ data, monthLabel, onRefresh, isReadOnly = false, artistProfiles }) {
      ...
      <div className={styles.capsule} style={{ padding: '24px' }}>
        ...
        <div className={styles.storySection}>
          ...
          <div className={styles.storyCard}>
            ...
            <p className={styles.storySubTitle}>That's <strong>{formattedTime}</strong> of pure vibes.</p>
          </div>
